  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "16px", lineHeight: "1.6", color: "#666" }}>
        Welcome to Anna University, where excellence in education meets a
      ...
      <p style={{ fontSize: "14px", color: "#777", marginTop: "30px" }}>
        ...
        contact us:
        <br />
        Address: [ Anna University Vinewood Street Cityville, Stateville
        23876 United States ]
        <br />
        Phone: [75628930]
        <br />
        Email: [Annauniversity@hotmail.com]
      </p>
    </div>
  );
};
